...
with open(os.path.join(TOPDIR, 'state/dbs/view_instances_def.json'), 'r') as f:
...
if VARIANT == 'prod':
  ...
  db_mapping = {'int/phys01': [dbs3_ip1_i2, {'reader':{},'writer':{}}],
                'int/phys02': [dbs3_ip2_i2, {'reader':{},'writer':{}}]}
elif VARIANT == 'dev':
  db_mapping = {'dev/phys01': [dbs3_dp1_i2, {'reader':{},'writer':{}}],
...
for viewname, access in [('DBSReader','reader'),('DBSWriter','writer')]:
