...
server.workspace('DQMContent', 19, 'Tracker', 'PixelPhase1', '^PixelPhase1/', '',
                  'PixelPhase1/Layouts/00a - ReportSummary: Layer or Disk vs subdet',
                  'PixelPhase1/Layouts/00e - Event Rate',
                  'PixelPhase1/Layouts/01a - Cluster Size vs Cluster Eta',                  
                  #'PixelPhase1/Layouts/02a - Cluster Position: Z vs Phi summary',
                  'PixelPhase1/Layouts/02b - Cluster Position: Z vs Phi PXLayers summary',
                  'PixelPhase1/Layouts/02c - Cluster Position: X vs Y PXDisks summary',                  
                  'PixelPhase1/Layouts/04a - OnTrack Cluster Charge',                 
                  'PixelPhase1/Layouts/05a - Cluster Size Summary',                 
                  'PixelPhase1/Layouts/06a - Num Clusters Summary',                 
                  'PixelPhase1/Layouts/07a - Digi ADC PXBarrel',
                  'PixelPhase1/Layouts/07b - Digi ADC PXForward',                 
                  'PixelPhase1/Layouts/08a - Cluster Charge Summary',                 
                  'pixelPhase1/Layouts/10a - Cluster Occupancy: Ladder vs Module in PXLayers',
                  'pixelPhase1/Layouts/10b - Cluster Occupancy: BladePannel vs Disk in PXRings',
                  'pixelPhase1/Layouts/11a - Digi Occupancy: Ladder vs Module in PXLayers',
                  'pixelPhase1/Layouts/11b - Digi Occupancy: BladePannel vs Disk in PXRings',
                  #'PixelPhase1/Layouts/19 - PixelPhase1 Digis: Ladder vs Module barrel summary',#were cluster_num
