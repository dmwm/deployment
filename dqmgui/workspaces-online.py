...
server.workspace('DQMContent', 19, 'Tracker', 'PixelPhase1', '^PixelPhase1/', '',
                  'PixelPhase1/Layouts/01a - PixelPhase1_Event_Rate_per_BX',
                  'PixelPhase1/Layouts/01c - PixelPhase1 Cluster Size vs Cluster Eta',
                  'PixelPhase1/Layouts/02 - PixelPhase1_Digi_Barrel_Summary',
                  'PixelPhase1/Layouts/03 - PixelPhase1_Digi_Endcap_Summary',
                  'PixelPhase1/Layouts/04 - PixelPhase1_Cluster_Number_Summary',
                  'PixelPhase1/Layouts/05 - PixelPhase1_Cluster_Charge_Summary',
                  'PixelPhase1/Layouts/06 - PixelPhase1_Cluster_Size_Summary',
                  'PixelPhase1/Layouts/17 - PixelPhase1 Digis: Ladder vs Module summary',
