...
server.workspace('DQMContent', 10, 'Trigger', 'L1T', '^(L1T|L1T2016)/', '',
                 ...
                 'L1T/Layouts/Stage2-QuickCollection/51 - uGMT Muon Copy 1-5 misMatch Ratios',
                 'L1T/Layouts/Stage2-QuickCollection/52 - Input vs Output misMatch Ratios (clockwise from top left: uGT vs. uGMT, uGT vs. caloL2, uGMT vs. EMTF, uGMT vs. OMTF, uGMT vs. BMTF)',
                 'L1T/Layouts/Stage2-QuickCollection/53 - uGMT Zero Suppression misMatch Ratio (left: all events, right: fat events)',
                 'L1T/Layouts/Stage2-QuickCollection/54 - BMTF Zero Suppression misMatch Ratio (left: all events, right: fat events)',
                )
