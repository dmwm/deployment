...
server.workspace('DQMContent', 10, 'Trigger', 'L1T', '^(L1T|L1T2016)/', '',
		 ...
		 'L1T/Layouts/Stage2-QuickCollection/27 - Non-Isolated Tau Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/28 - ETTEM Et distribution',
                 ...
                 'L1T/Layouts/Stage2-QuickCollection/35 - MET Et distribution',
                 'L1T/Layouts/Stage2-QuickCollection/36 - MHTHF Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/37 - MHTHF Et distribution',
	         'L1T/Layouts/Stage2-QuickCollection/38 - MHT Phi distribution',
	         'L1T/Layouts/Stage2-QuickCollection/39 - MHT Et distribution',
                )
