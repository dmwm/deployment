...
server.workspace('DQMContent', 10, 'Trigger', 'L1T', '^(L1T|L1T2016)/', '',
		 ...
		 'L1T/Layouts/Stage2-QuickCollection/10 - Central Jet Bx Occupancy distribution',
		 'L1T/Layouts/Stage2-QuickCollection/11 - Central Jet Et Eta vs Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/12 - Central Jets Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/13 - Forward Jet Bx Occupancy distribution',
		 'L1T/Layouts/Stage2-QuickCollection/14 - Forward Jet Et Eta vs Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/15 - Forward Jet Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/16 - Isolated EG Bx Occupancy distribution',
		 'L1T/Layouts/Stage2-QuickCollection/17 - Isolated EG Et Eta vs Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/18 - Isolated EG Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/19 - Non-Isolated EG Bx Occupancy distribution',
		 'L1T/Layouts/Stage2-QuickCollection/20 - Non-Isolated EG Et Eta vs Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/21 - Non-Isolated EG Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/22 - Isolated Tau Bx Occupancy distribution',
		 'L1T/Layouts/Stage2-QuickCollection/23 - Isolated Tau Et Eta vs Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/24 - Isolated Tau Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/25 - Non-Isolated Tau Bx Occupancy distribution',
		 'L1T/Layouts/Stage2-QuickCollection/26 - Non-Isolated Tau Et Eta vs Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/27 - Isolated Tau Pt distribution',
		 'L1T/Layouts/Stage2-QuickCollection/28 - ETTEM Et distribution',
                 'L1T/Layouts/Stage2-QuickCollection/29 - ETT Et distribution',
                 'L1T/Layouts/Stage2-QuickCollection/30 - EtSun Bx Occupancy distribution',
                 'L1T/Layouts/Stage2-QuickCollection/31 - HTT Et distribution',
                 'L1T/Layouts/Stage2-QuickCollection/32 - METHF Phi distribution',
                 'L1T/Layouts/Stage2-QuickCollection/33 - METHF Et distribution',
                 'L1T/Layouts/Stage2-QuickCollection/34 - MET Phi distribution',
                 'L1T/Layouts/Stage2-QuickCollection/35 - MET Rank distribution',
                 'L1T/Layouts/Stage2-QuickCollection/36 - MHTHF Phi distribution',
		 'L1T/Layouts/Stage2-QuickCollection/37 - MHTHF Rank distribution',
	         'L1T/Layouts/Stage2-QuickCollection/38 - MHT Phi distribution',
	         'L1T/Layouts/Stage2-QuickCollection/39 - MHT Rank distribution',
                )
