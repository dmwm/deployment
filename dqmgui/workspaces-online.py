...
server.workspace('DQMContent', 30, 'Calorimeter', 'HCAL', '^Hcal/', '',
                 'Hcal/Layouts/01 HCAL  Summary',
                 'Hcal/Layouts/02 HCAL DIGI Occupancy vs LS',
                 'Hcal/Layouts/03 HCAL DIGI Occupancy 2D',
                 'Hcal/Layouts/04 HCAL DIGI Missing Channels per 1LS',
                 'Hcal/Layouts/05 HCAL DIGI Missing Channels per 1LS vs LS',
                 'Hcal/Layouts/06 HCAL RECHIT Timing 2D',
                 'Hcal/Layouts/07 HCAL RECHIT HBHEabc Timing',
                 'Hcal/Layouts/08 HCAL RECHIT Energy 2D',
                 'Hcal/Layouts/09 HCAL RECHIT Energy per SubDetector',
                 'Hcal/Layouts/10 HCAL TP Occupancy vs LS',
                 'Hcal/Layouts/11 HCAL TP Occupancy 2D',
                 'Hcal/Layouts/12 HCAL TP Et Correlation Ratio vs LS',
                 'Hcal/Layouts/13 HCAL TP Et Correlation 2D',
                 'Hcal/Layouts/13 HCAL TP Number of Mismatches vs LS'
                )
server.workspace('DQMContent',30,'Calorimeter','HCALcalib', '^HcalCalib/', '',
                 'HcalCalib/Layouts/01 HCAL PEDESTAL MEANs',
				 'HcalCalib/Layouts/02 HCAL PEDESTAL RMSs',
				 'HcalCalib/Layouts/03 HCAL PEDESTAL MEANs 2D',
				 'HcalCalib/Layouts/01 HCAL PEDESTAL RMSs'
                )
