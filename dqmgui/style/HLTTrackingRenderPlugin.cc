/*!
  \file HLTTrackingRenderPlugin.cc
  \brief Display Plugin for Tracking and SiStrip @HLT DQM Histograms
...
class HLTTrackingRenderPlugin : public DQMRenderPlugin
{
public:
  virtual bool applies( const VisDQMObject &o, const VisDQMImgInfo & )
    {
      if ((o.name.find( "HLT/SiStrip/" ) == std::string::npos) &&
	  (o.name.find( "HLT/Tracking/" ) == std::string::npos))
         return false;
...
static HLTTrackingRenderPlugin instance;
