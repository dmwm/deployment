...
server.workspace('DQMContent', 19, 'Tracker', 'PixelPhase1', '^PixelPhase1/', '',
                  ...
                  'PixelPhase1/Layouts/05 - ntracks',
                  'PixelPhase1/Layouts/06 - OnTrack Cluster size',
                  'PixelPhase1/Layouts/07 - OnTrack Cluster and Vertices per Lumisection',
                  'PixelPhase1/Layouts/08a - Cluster Size Summary',
                  'PixelPhase1/Layouts/09a - Num Clusters Summary',
                  'PixelPhase1/Layouts/10a - Digi ADC PXBarrel',
                  'PixelPhase1/Layouts/10b - Digi ADC PXForward',
                  'PixelPhase1/Layouts/13a - Cluster Occupancy: Ladder vs Module in PXLayers',
                  'PixelPhase1/Layouts/13b - Cluster Occupancy: BladePannel vs Disk in PXRings',
                  'PixelPhase1/Layouts/14a - Digi Occupancy: Ladder vs Module in PXLayers',
                  'PixelPhase1/Layouts/14b - Digi Occupancy: BladePannel vs Disk in PXRings',                
                  'PixelPhase1/Layouts/17a - Ontrack Cluster Position: Z vs Phi Summary',
                  'PixelPhase1/Layouts/17b -  Ontrack Cluster Position: Z vs Phi in PXLayers',
                )
