...
shiftdtlayout(dqmitems, "05-NoiseSummary",
              [{ 'path': "DT/05-Noise/NoiseSummary", 'description': "<a href=https://twiki.cern.ch/twiki/bin/viewauth/CMS/DQMShiftDT>Description for the <b>Central DQM Offline shifter</b></a>" }])
