...
l1tlayout(dqmitems,"23 - Ratio L1TMuons BX FirstBunch minus1",
    [{'path': "L1T/L1TObjects/L1TMuon/timing/First_bunch/Ratio_L1TMuons_BX_FirstBunch_minus1", 'description': "Fraction of L1T Muon objects found in BX -1 over all L1T Muon objects found in a BX range of +/-2 BX around BX 0.", 'draw': { 'withref': "no" }}])
l1tlayout(dqmitems,"24 - Ratio L1TJet BX FirstBunch minus1",
