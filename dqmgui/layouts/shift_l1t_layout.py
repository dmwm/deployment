...
l1tlayout(dqmitems,"19 - uGT # of algo accepts relative to # of all algo accepts in +-2 BX vs. BX number in event for first bunch in train",
...
l1tlayout(dqmitems,"20 - uGT # of algo accepts relative to # of all algo accepts in +-2 BX vs. BX number in event for last bunch in train",
...
l1tlayout(dqmitems,"21 - uGT # of unprescaled algo accepts relative to # of all algo accepts in +-2 BX vs. BX number in event for first bunch in train",
...
l1tlayout(dqmitems,"22 - uGT # of unprescaled algo accepts relative to # of all algo accepts in +-2 BX vs. BX number in event for last bunch in train",
...
l1tlayout(dqmitems,"23 - uGT # of prescaled algo accepts relative to # of all algo accepts in +-2 BX vs. BX number in event for first bunch in train",
...
l1tlayout(dqmitems,"24 - uGT # of prescaled algo accepts relative to # of all algo accepts in +-2 BX vs. BX number in event for last bunch in train",
