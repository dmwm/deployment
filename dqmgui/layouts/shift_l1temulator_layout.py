...
l1temulayout(dqmitems,"00-RCT (Dis)Agreement Flag",
...
l1temulayout(dqmitems,"01-Stage1Layer2 (Dis)Agreement Flag",
...
l1temulayout(dqmitems,"02-DTTF (Dis)Agreement Flag",
...
l1temulayout(dqmitems,"03-RPC (Dis)Agreement Flag",
...
l1temulayout(dqmitems,"04-GMT (Dis)Agreement Flag",
...
l1temulayout(dqmitems,"05-GT (Dis)Agreement Flag",
             [{'path': "L1TEMU/GTexpert/GTErrorFlag", 'description': "Data|Emulator disagreement type for GT. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftTriggerEmulator\">here</a>."}])
