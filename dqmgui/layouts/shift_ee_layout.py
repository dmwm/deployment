...
shifteelayout(dqmitems, "03 Pedestal Online Quality",
...
shifteelayout(dqmitems, "04 Timing Summary",
...
shifteelayout(dqmitems, "08 Blue Laser (L3) Quality",
  [{ 'path': "EcalEndcap/EESummaryClient/EELT EE - laser quality summary L3", 'description': "Quality summary of blue laser events. Expect green where the laser sequence fired, yellow elsewhere. Red spots are failed channels. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" },
   { 'path': "EcalEndcap/EESummaryClient/EELT EE + laser quality summary L3", 'description': "Quality summary of blue laser events. Expect green where the laser sequence fired, yellow elsewhere. Red spots are failed channels. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }],
  [{ 'path': "EcalEndcap/EESummaryClient/EELT PN laser quality summary L3", 'description': "Quality summary of blue laser events on PN diodes. Expect green where the laser sequence fired, yellow or white elsewhere. Red spots are failed channels. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }])
...
shifteelayout(dqmitems, "10 TestPulse Quality",
...
shifteelayout(dqmitems, "11 Synchronization Error Trend",
