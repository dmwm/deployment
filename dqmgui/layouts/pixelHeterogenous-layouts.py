...
pixelHeterolayout(dqmitems, "00b - Compare number of vertices",
   [{ 'path':  "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/nVertex",
...
pixelHeterolayout(dqmitems, "09a - Compare track properties",
   [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/eta",
      'description': "Compare track #eta",
      'draw': { 'withref': "no", 'drawopts': "COLZ" }},
    { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/phi",
      'description': "Compare track #phi",
      'draw': { 'withref': "no" }},
    { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/pt",
      'description': "Compare track pt",
      'draw': { 'withref': "no" }}],
   [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/ptLogLog",
      'description': "Compare track pt in log scale",
      'draw': { 'withref': "no" }},
     { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/nChi2ndof",
      'description': "Compare track Chi2ndof",
      'draw': { 'withref': "no" }},
     { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/nLayers",
      'description': "Compare number of layers per track",
      'draw': { 'withref': "no" }}]
   )

pixelHeterolayout(dqmitems, "09b - Compare track properties",
    [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/z",
      'description': "Compare track z",
      'draw': { 'withref': "no" }},
     { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/tip",
...
pixelHeterolayout(dqmitems, "10 - Track matching phase space",
    [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/phiztrkAllCPU",
      'description': "phi-z map of CPU tracks(with >= loose quality)",
      'draw': { 'withref': "no" }},
     { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/phiztrkAllCPUmatched",
      'description': "phi-z map of CPU tracks(with >= loose quality) matched to a GPU track",
      'draw': { 'withref': "no" }}],
   [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/ptetatrkAllCPU",
...
pixelHeterolayout(dqmitems, "11 - Differences in track properties",
    [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/etadiffmatched",
      'description': "Difference in eta for matched tracks",
      'draw': { 'withref': "no" }},
     { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/phidiffmatched",
      'description': "Difference in phi for matched tracks",
      'draw': { 'withref': "no" }}],
   [{ 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/ptdiffmatched",
      'description': "Difference in pt for matched tracks",
      'draw': { 'withref': "no", 'drawopts': "COLZ" }},
    { 'path': "SiPixelHeterogeneous/PixelTracksGPUvsCPU/zdiffmatched",
      'description': "Difference in z for matched tracks",
      'draw': { 'withref': "no" }}]
   )

pixelHeterolayout(dqmitems, "12a - Compare vertices",
    [{ 'path': "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/chi2",
      'description': "Compare vertex chi-squared",
      'draw': { 'withref': "no" }},
     { 'path': "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/chi2oNdof",
      'description': "Compare Vertex chi-squared/Ndof",
      'draw': { 'withref': "no" }}],
   [{ 'path': "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/ntrk",
      'description': "Compare number of tracks associated to a vertex",
      'draw': { 'withref': "no", 'drawopts': "COLZ" }},
    { 'path': "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/ptsq",
...
pixelHeterolayout(dqmitems, "12b - Compare vertices",
    [{ 'path': "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/vz",
      'description': "Compare vertex z",
      'draw': { 'withref': "no" }}],
    [{ 'path': "SiPixelHeterogeneous/PixelVerticesGPUvsCPU/vx",
