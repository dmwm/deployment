...
pixellayout(dqmitems, "44a - Dead Channels per ROC per Barrel Layer",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_PCL/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_1",
     'description': "Dead Channels per ROC in PXLayer 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_PCL/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_2",
     'description': "Dead Channels per ROC in PXLayer 2",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_PCL/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_3",
     'description': "Dead Channels per ROC in PXLayer 3",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_PCL/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_4",
     'description': "Dead Channels per ROC in PXLayer 4",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "44b - Dead Channels per ROC per Forward Ring",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_PCL/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_1",
     'description': "Dead Channels per ROC in PXRing 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_PCL/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_2",
     'description': "Dead Channels per ROC in PXRing 2",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "44c - Dead Channels per ROC per Barrel Layer",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_FEDerror/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_1",
     'description': "Dead Channels per ROC in PXLayer 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_FEDerror/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_2",
     'description': "Dead Channels per ROC in PXLayer 2",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_FEDerror/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_3",
     'description': "Dead Channels per ROC in PXLayer 3",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_FEDerror/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_4",
     'description': "Dead Channels per ROC in PXLayer 4",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "44d - Dead Channels per ROC per Forward Ring",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_FEDerror/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_1",
     'description': "Dead Channels per ROC in PXRing 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_FEDerror/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_2",
     'description': "Dead Channels per ROC in PXRing 2",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "44e - Dead Channels per ROC per Barrel Layer",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Other/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_1",
     'description': "Dead Channels per ROC in PXLayer 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Other/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_2",
     'description': "Dead Channels per ROC in PXLayer 2",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Other/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_3",
     'description': "Dead Channels per ROC in PXLayer 3",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Other/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_4",
     'description': "Dead Channels per ROC in PXLayer 4",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "44f - Dead Channels per ROC per Forward Ring",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Other/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_1",
     'description': "Dead Channels per ROC in PXRing 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Other/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_2",
     'description': "Dead Channels per ROC in PXRing 2",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "45a - Permanent Dead Channels per ROC",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Permanent/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_1",
     'description': "Dead Channels per ROC in PXLayer 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Permanent/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_2",
     'description': "Dead Channels per ROC in PXLayer 2",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Permanent/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_3",
     'description': "Dead Channels per ROC in PXLayer 3",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Permanent/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_4",
     'description': "Dead Channels per ROC in PXLayer 4",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Permanent/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_1",
     'description': "Dead Channels per ROC in PXRing 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Permanent/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_2",
     'description': "Dead Channels per ROC in PXRing 2",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "45b - Prompt Dead Channels per ROC",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Prompt/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_1",
     'description': "Dead Channels per ROC in PXLayer 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Prompt/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_2",
     'description': "Dead Channels per ROC in PXLayer 2",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Prompt/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_3",
     'description': "Dead Channels per ROC in PXLayer 3",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Prompt/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_4",
     'description': "Dead Channels per ROC in PXLayer 4",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Prompt/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_1",
     'description': "Dead Channels per ROC in PXRing 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_Prompt/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_2",
     'description': "Dead Channels per ROC in PXRing 2",
     'draw': {'withref' : "no"}}],
  )

pixellayout(dqmitems, "45c - StuckTBM Dead Channels per ROC",
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_StuckTBM/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_1",
     'description': "Dead Channels per ROC in PXLayer 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_StuckTBM/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_2",
     'description': "Dead Channels per ROC in PXLayer 2",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_StuckTBM/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_3",
     'description': "Dead Channels per ROC in PXLayer 3",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_StuckTBM/Dead Channels per ROC_per_SignedModuleCoord_per_SignedLadderCoord_PXLayer_4",
     'description': "Dead Channels per ROC in PXLayer 4",
     'draw': {'withref' : "no"}}],
  [{ 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_StuckTBM/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_1",
     'description': "Dead Channels per ROC in PXRing 1",
     'draw': {'withref' : "no"}},
   { 'path': "PixelPhase1/SiPixelQualityPCL/BadROC_StuckTBM/Dead Channels per ROC_per_SignedDiskCoord_per_SignedBladePanelCoord_PXRing_2",
     'description': "Dead Channels per ROC in PXRing 2",
     'draw': {'withref' : "no"}}],
  )
