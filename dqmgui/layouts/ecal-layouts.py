...
ecallayout(dqmitems, 'Ecal/Layouts/00 Overview/04 Noise',
	   [{'path': 'EcalBarrel/EBSummaryClient/EBPOT pedestal quality summary G12', 'description': 'Summary of the presample data quality. A channel is red if presample mean is outside the range (175.0, 260.0), or (175.0, 300.0) for the forward region, or RMS is greater than 6.0.  Channels with entries less than 6 are not considered.'}],
	   [{'path': 'EcalEndcap/EESummaryClient/EEPOT EE - pedestal quality summary G12', 'description': 'Summary of the presample data quality. A channel is red if presample mean is outside the range (175.0, 260.0), or (175.0, 300.0) for the forward region, or RMS is greater than 6.0. Channels with entries less than 6 are not considered.'},
	    {'path': 'EcalEndcap/EESummaryClient/EEPOT EE + pedestal quality summary G12', 'description': 'Summary of the presample data quality. A channel is red if presample mean is outside the range (175.0, 260.0), or (175.0, 300.0) for the forward region, or RMS is greater than 6.0. Channels with entries less than 6 are not considered.'}])
...
ecallayout(dqmitems, 'Ecal/Layouts/00 Overview/06 Timing',
	   [{'path': 'EcalBarrel/EBSummaryClient/EBTMT timing quality summary', 'description': 'Summary of the timing data quality. A 5x5 tower is red if the mean timing of the tower is off by more than 2.0 for EB and 3.0 for EE, or RMS is greater than 6.0 (6.0 and 12.0 in forward region). Towers with total entries less than 3 (or 24 in forward region) are not subject to this evaluation. Since 5x5 tower timings are calculated with a tighter time-window than per-channel timings, a tower can additionally become red if its the sum of per-channel timing histogram entries is greater than per-tower histogram entries by factor 1.66666666667 (significant fraction of events fall outside the tight time-window).'}],
	   [{'path': 'EcalEndcap/EESummaryClient/EETMT EE - timing quality summary', 'description': 'Summary of the timing data quality. A 5x5 tower is red if the mean timing of the tower is off by more than 2.0 for EB and 3.0 for EE, or RMS is greater than 6.0 (6.0 and 12.0 in forward region). Towers with total entries less than 3 (or 24 in forward region) are not subject to this evaluation. Since 5x5 tower timings are calculated with a tighter time-window than per-channel timings, a tower can additionally become red if its the sum of per-channel timing histogram entries is greater than per-tower histogram entries by factor 1.66666666667 (significant fraction of events fall outside the tight time-window).'},
	    {'path': 'EcalEndcap/EESummaryClient/EETMT EE + timing quality summary', 'description': 'Summary of the timing data quality. A 5x5 tower is red if the mean timing of the tower is off by more than 2.0 for EB and 3.0 for EE, or RMS is greater than 6.0 (6.0 and 12.0 in forward region). Towers with total entries less than 3 (or 24 in forward region) are not subject to this evaluation. Since 5x5 tower timings are calculated with a tighter time-window than per-channel timings, a tower can additionally become red if its the sum of per-channel timing histogram entries is greater than per-tower histogram entries by factor 1.66666666667 (significant fraction of events fall outside the tight time-window).'}])
ecallayout(dqmitems, 'Ecal/Layouts/00 Overview/07 Trigger Primitives',
	   [{'path': 'EcalBarrel/EBSummaryClient/EBTTT emulator error quality summary', 'description': 'Summary of emulator matching quality. A tower is red if the number of events with Et emulation error is greater than 0.2 of total events. Towers with entries less than 3 are not considered. Also, an entire SuperModule can show red if its (data) Trigger Primitive digi occupancy is less than 5sigma of the overall SuperModule mean, or if more than 80% of its Trigger Towers are showing any number of TT Flag-Readout Mismatch errors. Finally, if the fraction of towers in a SuperModule that are permanently masked or have TTF4 flag set is greater than 0.1, then the entire supermodule shows red.'}],
...
ecallayout(dqmitems, 'Ecal/Layouts/00 Overview/08 Hot Cells',
	   [{'path': 'EcalBarrel/EBSummaryClient/EBOT hot cell quality summary', 'description': 'Summary of the hot cell monitor. A channel is red if it has more than 100.0 times more entries than phi-ring mean in either digi, rec hit (filtered), or TP digi (filtered). Channels with less than 20 entries are not considered.'}],
	   [{'path': 'EcalEndcap/EESummaryClient/EEOT EE - hot cell quality summary', 'description': 'Summary of the hot cell monitor. A channel is red if it has more than 100.0 times more entries than phi-ring mean in either digi, rec hit (filtered), or TP digi (filtered). Channels with less than 20 entries are not considered.'},
	    {'path': 'EcalEndcap/EESummaryClient/EEOT EE + hot cell quality summary', 'description': 'Summary of the hot cell monitor. A channel is red if it has more than 100.0 times more entries than phi-ring mean in either digi, rec hit (filtered), or TP digi (filtered). Channels with less than 20 entries are not considered.'}])
...
ecallayout(dqmitems, 'Ecal/Layouts/00 Overview/09 Laser 3 (Blue)',
	   ...
	   [{'path': 'EcalEndcap/EESummaryClient/EELT EE - laser quality summary L3', 'description': 'Summary of the laser data quality. A channel is red either if mean / expected < 0.1 (0.01 for Fwd regions), or if mean / expected > 2.06, or if RMS / expected > 0.3, or if mean timing is off from expected by 1.0. Expected amplitudes and timings are 1700.0, 1300.0, 1700.0, 1700.0 and 4.2, 3.7, 4.2, 4.2 for lasers 1, 2, 3, and 4 respectively. Channels with less than 3 are not considered.'},
	    {'path': 'EcalEndcap/EESummaryClient/EELT EE + laser quality summary L3', 'description': 'Summary of the laser data quality. A channel is red either if mean / expected < 0.1 (0.01 for Fwd regions), or if mean / expected > 2.06, or if RMS / expected > 0.3, or if mean timing is off from expected by 1.0. Expected amplitudes and timings are 1700.0, 1300.0, 1700.0, 1700.0 and 4.2, 3.7, 4.2, 4.2 for lasers 1, 2, 3, and 4 respectively. Channels with less than 3 are not considered.'}])
ecallayout(dqmitems, 'Ecal/Layouts/00 Overview/09 Laser 4 (Green2)',
	   ...
	   [{'path': 'EcalEndcap/EESummaryClient/EELT EE - laser quality summary L4', 'description': 'Summary of the laser data quality. A channel is red either if mean / expected < 0.1 (0.01 for Fwd regions), or if mean / expected > 2.06, or if RMS / expected > 0.3, or if mean timing is off from expected by 1.0. Expected amplitudes and timings are 1700.0, 1300.0, 1700.0, 1700.0 and 4.2, 3.7, 4.2, 4.2 for lasers 1, 2, 3, and 4 respectively. Channels with less than 3 are not considered.'},
	    {'path': 'EcalEndcap/EESummaryClient/EELT EE + laser quality summary L4', 'description': 'Summary of the laser data quality. A channel is red either if mean / expected < 0.1 (0.01 for Fwd regions), or if mean / expected > 2.06, or if RMS / expected > 0.3, or if mean timing is off from expected by 1.0. Expected amplitudes and timings are 1700.0, 1300.0, 1700.0, 1700.0 and 4.2, 3.7, 4.2, 4.2 for lasers 1, 2, 3, and 4 respectively. Channels with less than 3 are not considered.'}])
...
ecallayout(dqmitems, 'Ecal/Layouts/01 Raw Data/17 DCC-SRP Desync Trend',
    ...
    for channel in range(1, maxchannel+1): # Loop over channels
      ...
      ecallayout(dqmitems,'Ecal/Layouts/05 Timing/By SuperModule/Quality/Quality %s' % channellabel,
                 [{'path': 'Ecal%s/%sTimingClient/%sTMT timing quality %s' % (detector, label, label, channellabel),
                   'description': 'Summary of the timing data quality. A channel is red if its mean timing is off by more than 2.0 for EB and 3.0 for EE, or RMS is greater than 6.0. Channels with entries less than 1 (or 8 in forward region) are not considered.'}])
...
ecallayout(dqmitems, 'Ecal/Layouts/11 Trend/11 DCC-TCC Desync Trend',
        [{'path': 'Ecal/Trends/RawDataTask number of EBRDT bunch crossing TCC errors', 'description': 'Trend of the number of bunch crossing value mismatches between DCC and TCC in EB.'},
         {'path': 'Ecal/Trends/RawDataTask number of EBRDT L1A TCC errors', 'description': 'Trend of the number of L1A value mismatches between DCC and TCC in EB.'}],
        [{'path': 'Ecal/Trends/RawDataTask number of EERDT bunch crossing TCC errors', 'description': 'Trend of the number of bunch crossing value mismatches between DCC and TCC in EE.'},
         {'path': 'Ecal/Trends/RawDataTask number of EERDT L1A TCC errors', 'description': 'Trend of the number of L1A value mismatches between DCC and TCC in EE.'}])
ecallayout(dqmitems, 'Ecal/Layouts/11 Trend/12 DCC-SRP Desync Trend',
        [{'path': 'Ecal/Trends/RawDataTask number of EBRDT bunch crossing SRP errors', 'description': 'Trend of the number of bunch crossing value mismatches between DCC and SRP in EB.'},
         {'path': 'Ecal/Trends/RawDataTask number of EBRDT L1A SRP errors', 'description': 'Trend of the number of L1A value mismatches between DCC and SRP in EB'}],
        [{'path': 'Ecal/Trends/RawDataTask number of EERDT bunch crossing SRP errors', 'description': 'Trend of the number of bunch crossing value mismatches between DCC and SRP in EE.'},
         {'path': 'Ecal/Trends/RawDataTask number of EERDT L1A SRP errors', 'description': 'Trend of the number of L1A value mismatches between DCC and SRP in EE'}])
  ...
  for sign in ['-', '+']: # Loop over z-side
    for channel in range(1, maxchannel+1): # Loop over channels
      ...
      ecallayout(dqmitems,'Ecal/Layouts/12 By SuperModule/%s/03 Presample Quality' % channellabel,
                 [{'path': 'Ecal%s/%sPedestalOnlineClient/%sPOT pedestal quality G12 %s' % (detector, label, label, channellabel),
                   'description': 'Summary of the presample data quality. A channel is red if presample mean is outside the range (175.0, 260.0) or (175.0, 300.0) for the forward region, or RMS is greater than 6.0. Channels with entries less than 6 are not considered.'}])
