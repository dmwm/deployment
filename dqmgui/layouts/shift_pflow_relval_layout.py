def shiftpflowlayout(i, p, *rows): i["00 Shift/PFlow/" + p] = DQMItem(layout=rows)
#def shiftpflowlayout(i, p, *rows): i[p] = DQMItem(layout=rows)

#def shiftpflowjetreslayout(i, p , *rows): i["PTJetRes/" + p] = DQMItem(layout=rows)
