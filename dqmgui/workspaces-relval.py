...
server.workspace('DQMContent', 31, 'Monte Carlo', 'MC Tk Phase-2' , '^TrackerPhase2(OT|IT)(Cluster|L1Track|RecHit|Stub|TrackingRecHit)V', 'MCLayouts/Phase2Tk',
                 ...
                 "MCLayouts/Phase2Tk/304 - OT Cluster Endcap MINUS TEDD1 Ring1 Pixel and Strip Delta X and Y",
                 "MCLayouts/Phase2Tk/305 - OT Cluster Endcap MINUS TEDD2 Ring1 Pixel and Strip Delta X and Y",
                 "MCLayouts/Phase2Tk/306 - OT Cluster Endcap PLUS TEDD1 Ring1 Pixel and Strip Delta X and Y",
                 "MCLayouts/Phase2Tk/307 - OT Cluster Endcap PLUS TEDD2 Ring1 Pixel and Strip Delta X and Y",
                 "MCLayouts/Phase2Tk/400 - OT RecHit Barrel Pixel X",
                 "MCLayouts/Phase2Tk/401 - OT RecHit Barrel Pixel Y",
                 "MCLayouts/Phase2Tk/402 - OT RecHit Barrel Strip X",
                 "MCLayouts/Phase2Tk/403 - OT RecHit Barrel Strip Y",
                 ...
                 "MCLayouts/Phase2Tk/503 - OT L1Track d0 Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/504 - OT L1Track z0 Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/505 - OT Extended L1Track Displaced Eta Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/506 - OT Extended L1Track Displaced Phi Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/507 - OT Extended L1Track Displaced Lxy Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/508 - OT Extended L1Track Displaced d0 Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/509 - OT Extended L1Track Prompt Eta Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/510 - OT Extended L1Track Prompt Phi Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/511 - OT Extended L1Track Prompt Lxy Efficiency and Resolution",
                 "MCLayouts/Phase2Tk/512 - OT Extended L1Track Prompt d0 Efficiency and Resolution",)
